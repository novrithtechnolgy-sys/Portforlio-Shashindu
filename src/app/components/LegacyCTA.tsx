      ...
      <Container>
        <div className="relative overflow-hidden rounded-[34px]  bg-white/5 shadow-[0_50px_160px_rgba(0,0,0,0.85)]">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_45%_35%,rgba(255,255,255,0.10),rgba(0,0,0,0)_60%)]" />
          </div>

          {/* Content */}
          <div className="relative px-6 py-16 md:px-16 md:py-34 text-center">
            <h3 className="font-[timesTen] text-[80px] leading-[1.05] text-white">
              ...
              <span className="font-bold"> Your Legacy</span>
            </h3>

            <p className="mt-8 mx-auto max-w-4xl text-base md:text-lg text-white/70 leading-7 md:leading-8">
              I do not just build companies I build value chains Whether you need strategic digital
              marketing operational advice for hospitality or a partnership that drives growth let
              us bridge the gap between vision and execution
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-6">
              ...
              <a
                ...
                "
              >
                Start the Conversation <span className="text-white/80 text-lg leading-none">⌄</span>
              </a>
