      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        >
          ...
          <button
            onClick={prev}
            aria-label="Previous"
            className="hidden md:block absolute left-0 top-1/2 z-30 -translate-y-1/2 text-white/40 hover:text-white/70 transition text-5xl px-3"
          >
            ❮❮
          </button>
          ...
          <button
            onClick={next}
            aria-label="Next"
            className="hidden md:block absolute right-0 top-1/2 z-30 -translate-y-1/2 text-white/40 hover:text-white/70 transition text-5xl px-3"
          >
            ❯❯
          </button>
